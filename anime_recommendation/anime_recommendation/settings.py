...
SECRET_KEY = 'django-insecure-)w3zjh4+px#(8kaug3+)5_v5(t5l5by@2-mi&491xya0u0zfa3'
...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # Add the 'templates' directory
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'USER': 'dheeraj',
        'PASSWORD': 'Dheeraj@2002', # This is user or password
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
...
AUTH_USER_MODEL = 'anime_api.User'
